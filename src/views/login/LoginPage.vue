...
import { userRegisterServe, userLoginServe } from '@/api/user'
...
const register = async () => {
  ...
  await userRegisterServe(formModule.value)
...
const login = async () => {
  await form.value.validate()
  const res = await userLoginServe(formModule.value)
  userStore.getToken(res.data.token)
